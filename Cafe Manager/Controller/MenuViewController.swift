...
class MenuViewController: UIViewController {
    ...
    @IBAction func onAddFoofPressed(_ sender: UIButton) {
...
//        let doneAction = UIBarButtonItem(barButtonSystemItem: .done, target: nil, action: #selector(onValuePicked))
        ...
        txtCatagory.inputAccessoryView = pickerToolBar
        txtCatagory.inputView = categoryPicker
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        txtCatagory.text = categoryList[row].categoryName
